...
speaker     = "s31"           # use val/test speaker
filename    = "bbav5s"       # without extension
...
mixed_mag = np.power(np.maximum(mixed_unnorm, 1e-8), 1/0.3)  # (time_frames, 257)
